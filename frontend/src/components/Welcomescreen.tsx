...
const PATHS: Array<{ id: PathId; title: string; subtitle: string; description: string; gradient: string; iconPath: string }> = [
  { id: 'stockLookup', title: 'I Have a Stock Number', subtitle: 'Find the exact vehicle', description: 'Enter your stock number to view availability, pricing, and schedule a test drive.', gradient: 'linear-gradient(135deg, #1B7340 0%, #22c55e 100%)', iconPath: 'M11 11m-8 0a8 8 0 1 0 16 0a8 8 0 1 0 -16 0M21 21l-4.35-4.35M11 8v6M8 11h6' },
  { id: 'modelBudget', title: 'I Know What I Want', subtitle: 'Browse by model & budget', description: 'Select your preferred model and set your budget to see matching vehicles in stock.', gradient: 'linear-gradient(135deg, #3b82f6 0%, #60a5fa 100%)', iconPath: 'M7 17m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0M17 17m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0M5 17h-2v-6l2-5h9l4 5h1a2 2 0 0 1 2 2v4h-2m-4 0h-6m-6 -6h15m-6 0v-5' },
  { id: 'aiAssistant', title: 'Chat with Quirk AI', subtitle: "LET'S HAVE A CONVERSATION", description: "Let's walk through this together and find the right vehicle that fits what you're looking for.", gradient: 'linear-gradient(135deg, #8b5cf6 0%, #a78bfa 100%)', iconPath: 'M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z' },
];
...
const s: Record<string, CSSProperties> = {
  ...
  bgOverlay: { position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'linear-gradient(180deg, rgba(0,0,0,0.65) 0%, rgba(0,0,0,0.82) 100%)', zIndex: 1 },
  ...
  inlineAvatar: { width: '56px', height: '56px', borderRadius: '50%', background: 'linear-gradient(135deg, #22c55e 0%, #1B7340 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, boxShadow: '0 6px 24px rgba(34, 197, 94, 0.45)' },
  ...
  namePrompt: { fontSize: '18px', color: 'rgba(255,255,255,0.85)', margin: '0 0 12px 0' },
  phonePrompt: { fontSize: '18px', color: 'rgba(255,255,255,0.85)', margin: '0 0 12px 0' },
  inputContainer: { position: 'relative', width: '100%', maxWidth: '420px', marginBottom: '20px' },
  nameInput: { width: '100%', padding: '20px 26px', background: 'rgba(255,255,255,0.12)', border: '2px solid rgba(255,255,255,0.25)', borderRadius: '18px', color: '#fff', fontSize: '20px', fontWeight: 600, textAlign: 'center', backdropFilter: 'blur(12px)', boxSizing: 'border-box', transition: 'all 0.2s ease' },
  phoneInput: { width: '100%', padding: '20px 26px', background: 'rgba(255,255,255,0.12)', border: '2px solid rgba(255,255,255,0.25)', borderRadius: '18px', color: '#fff', fontSize: '18px', fontWeight: 500, textAlign: 'center', backdropFilter: 'blur(12px)', boxSizing: 'border-box', transition: 'all 0.2s ease' },
  nameActions: { display: 'flex', flexDirection: 'column', gap: '12px', marginBottom: '20px', width: '100%', maxWidth: '420px' },
  continueBtn: { width: '100%', padding: '20px 36px', background: 'linear-gradient(135deg, #1B7340 0%, #22c55e 100%)', border: 'none', borderRadius: '16px', color: '#fff', fontSize: '18px', fontWeight: 700, cursor: 'pointer', boxShadow: '0 8px 28px rgba(34, 197, 94, 0.4)', transition: 'all 0.2s ease' },
  skipBtn: { background: 'transparent', border: 'none', color: 'rgba(255,255,255,0.55)', fontSize: '14px', fontWeight: 500, cursor: 'pointer', padding: '12px', transition: 'color 0.2s ease' },
  privacyNote: { display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', fontSize: '12px', color: 'rgba(255,255,255,0.45)', margin: 0 },
  ...
  aiAvatar: { width: '60px', height: '60px', borderRadius: '50%', background: 'linear-gradient(135deg, #22c55e 0%, #1B7340 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', boxShadow: '0 6px 24px rgba(34, 197, 94, 0.4)' },
  ...
  pathCard: { flex: '1 1 320px', maxWidth: '380px', minHeight: '300px', padding: '36px', borderRadius: '24px', border: '1px solid rgba(255,255,255,0.15)', backdropFilter: 'blur(12px)', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', cursor: 'pointer', transition: 'all 0.35s ease', position: 'relative', overflow: 'hidden', boxShadow: '0 8px 32px rgba(0,0,0,0.3)' },
  pathIcon: { width: '88px', height: '88px', borderRadius: '22px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', marginBottom: '22px', transition: 'all 0.35s ease', boxShadow: '0 6px 24px rgba(0,0,0,0.3)' },
  pathTitle: { fontSize: '23px', fontWeight: 700, color: '#fff', margin: '0 0 6px 0' },
  pathSubtitle: { fontSize: '14px', fontWeight: 600, color: '#4ade80', margin: '0 0 14px 0', textTransform: 'uppercase', letterSpacing: '1px' },
  pathDescription: { fontSize: '14px', color: 'rgba(255,255,255,0.75)', margin: 0, lineHeight: 1.6, flex: 1 },
  pathArrow: { marginTop: '22px', color: 'rgba(255,255,255,0.6)', transition: 'transform 0.3s ease' },
  statsBar: { display: 'flex', alignItems: 'center', gap: '10px', padding: '18px 28px', background: 'linear-gradient(145deg, rgba(0,0,0,0.75) 0%, rgba(0,0,0,0.6) 100%)', backdropFilter: 'blur(14px)', borderRadius: '20px', border: '1px solid rgba(255,255,255,0.12)', marginBottom: '28px', position: 'relative', zIndex: 2, boxShadow: '0 8px 32px rgba(0,0,0,0.3)' },
  ...
  statBtnHover: { background: 'linear-gradient(135deg, rgba(74,222,128,0.2) 0%, rgba(34,197,94,0.15) 100%)', transform: 'scale(1.05)', boxShadow: '0 0 20px rgba(74,222,128,0.2)' },
  statNumber: { fontSize: '34px', fontWeight: 700, color: '#4ade80', textShadow: '0 0 20px rgba(74,222,128,0.3)' },
  statLabel: { fontSize: '12px', fontWeight: 600, color: 'rgba(255,255,255,0.55)', textTransform: 'uppercase', letterSpacing: '1px' },
  statDivider: { width: '1px', height: '44px', background: 'rgba(255,255,255,0.12)' },
  browseLink: { background: 'linear-gradient(145deg, rgba(0,0,0,0.6) 0%, rgba(0,0,0,0.4) 100%)', border: '1px solid rgba(255,255,255,0.2)', color: 'rgba(255,255,255,0.85)', fontSize: '16px', fontWeight: 600, cursor: 'pointer', padding: '14px 28px', borderRadius: '12px', position: 'relative', zIndex: 2, backdropFilter: 'blur(8px)', transition: 'all 0.2s ease' },
};
