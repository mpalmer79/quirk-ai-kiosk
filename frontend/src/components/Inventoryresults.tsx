...
const styles: Record<string, CSSProperties> = {
  ...
  sortSelect: {
    padding: '10px 16px',
    background: 'linear-gradient(145deg, rgba(30,30,35,0.9) 0%, rgba(20,20,25,0.9) 100%)',
  ...
  refineSection: {
    ...
    gap: '16px',
    padding: '24px',
    background: 'linear-gradient(145deg, rgba(30,30,35,0.6) 0%, rgba(20,20,25,0.6) 100%)',
    borderRadius: '16px',
