...
class TestCalculateSimilarityScore:
    ...
    def test_same_body_style_adds_points(self):
        v1 = {"bodyStyle": "Truck", "price": 50000, "fuelType": "Gasoline", "drivetrain": "4WD", "features": []}
        v2 = {"bodyStyle": "Truck", "price": 90000, "fuelType": "Diesel", "drivetrain": "2WD", "features": []}
    ...
    def test_similar_price_increases_score(self):
        ...
        v2 = {"bodyStyle": "SUV", "price": 52000, "fuelType": "Gasoline", "drivetrain": "AWD", "features": []}
        v3 = {"bodyStyle": "SUV", "price": 90000, "fuelType": "Gasoline", "drivetrain": "AWD", "features": []}
    ...
    def test_same_fuel_type_increases_score(self):
        ...
        v2 = {"bodyStyle": "SUV", "price": 60000, "fuelType": "Electric", "drivetrain": "AWD", "features": []}
        v3 = {"bodyStyle": "SUV", "price": 60000, "fuelType": "Gasoline", "drivetrain": "AWD", "features": []}
    ...
    def test_feature_overlap_increases_score(self):
        ...
        v2 = {"bodyStyle": "SUV", "price": 50000, "fuelType": "Gasoline", "drivetrain": "AWD", "features": ["Leather", "Nav", "Sunroof"]}
        v3 = {"bodyStyle": "SUV", "price": 50000, "fuelType": "Gasoline", "drivetrain": "AWD", "features": ["Basic"]}
